 ...
 *
 */
public class ClientTCP extends JFrame implements ActionListener, MouseListener {
		...
		public ClientTCP(String dir, String host, int port) {
			super("TCP CLIENT");
		...
		public static void main(String args[]) {
			...
			if(args.length >= 3){
				ClientTCP tcp = new TCPClient(args[0], args[1], Integer.parseInt(args[2]));
